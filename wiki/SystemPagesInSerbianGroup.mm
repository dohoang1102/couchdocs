...
##master-date:2004-03-1 00:00:00
#acl MoinPagesEditorGroup:read,write,delete,revert All:read
#format wiki
#language sr
Na ovoj listi su sve Sistemske``Stranice (uključujući i Pomoćne``Stranice) u ovom vikiju:
 ...
 * ŽeljeneStranice
 * StatistikaDogađaja
 * StatistikaDogađaja/BrojPoziva
 * StatistikaDogađaja/KorisničkiAgenti
 * VeličinaStranica
 * InterWiki
 * SlučajnaStranica
 ...
 * PomoćZaPočetnike
 * PomoćZaProgramere
 * IndeksPomoćnihStranica
 * RaznePomoćneTeme
 * RaznePomoćneTeme/EksperimentalneOsobine
 * RaznePomoćneTeme/ČestoPostavljenaPitanja
