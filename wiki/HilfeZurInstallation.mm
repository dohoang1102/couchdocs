...
##master-date: 2003-11-18 21:18:46
...
Diese Seite beschreibt, wie Sie vorgehen müssen, um MoinMoin ab Version 1.1 zu installieren. Im nächsten Abschnitt finden Sie eine Liste von konkreten [#installscenarios Installationsszenarien], die Ihnen dabei helfen, diese Anleitung auf verschiedenen Plattformen umzusetzen. Wenn Sie bereits ein Wiki laufen haben und upgraden wollen, lesen Sie bitte HilfeZumUpdaten.
...
Die Seite HilfeZurAdministration enthält dazu Verweise auf weitere Seiten, die diese Themen abdecken.
Insbesondere HilfeZurKonfiguration und HilfeZumUpdaten enthalten wertvolle Hinweise zur weiteren Konfiguration und Wartung Ihrer Wiki-Installation.

MoinMoin:MoinDev/TlaGuide beschreibt (in englischer Sprache), wie Sie ihr Wiki unter Verwendung der aktuellen Entwicklungsversion betreiben können, die sich im archive (tla) befindet.
