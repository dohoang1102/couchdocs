...
##master-date:2004-11-03 19:15:03
#acl MoinPagesEditorGroup:read,write,delete,revert All:read
#format wiki
#language da
Dette er en oversigt over alle danske System``Sider (inklusive Hjælpe``Sider) for denne wiki:
 ...
 * MoinMoin
  ...
  * ForSide - flyt ikke denne ind på første niveau, da vi ikke ønsker at opdatere denne side!
  * FortuneCookies
