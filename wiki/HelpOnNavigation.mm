...
#language en
 ...
 <!> Needs update for 1.3. Most of this is true only for classic
...
On the upper right you find icons for the most often used functions:
  * <<Icon(up)>> jumps to the parent page, and is only shown if you are on a subpage (see HelpOnEditing/SubPages)
  * <<Icon(print)>> shows a printable version of the page without the header or footer
  * <<Icon(raw)>> shows the source code of the current page
  * <<Icon(subscribe)>>/<<Icon(unsubscribe)>> allows to subscribe to email notifications for the current page, the brighter version means you have already subscribed to a page
  ...
  * <<Icon(find)>> shows the search page.
