...
If you change the contents of {{{MoinMoin/dict/}}} (because of adding new / removing old dictionaries) or if you create a new {{{MoinMoin/dict/}}} directory, then you have to delete the file {{{spellchecker.dict}}} (a new one will be created automagically).
