...
#format wiki
#language it
== Impostazione delle tue preferenze ==
 ...
 * ''Pagine wiki a cui sei iscritto'': questa funzionalità opzionale
 è attiva solo quando è abilitato il supporto email nel tuo wiki,
 vedi HelpOnConfiguration/EmailSupport per ulteriori dettagli.
