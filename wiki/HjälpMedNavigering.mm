...
Navigationsraden högst upp på varje sida ger dig möjlighet att gå till:
StartSidan,
SenasteÄndringar (lista på ändrade sidor),
TitelRegister (register över alla sidtitlar),
OrdRegister (register över alla ord i sidtitlar),
PlatsNavigering (lista på navigationshjälpmedel) och
HjälpInnehåll (huvudsidan för hjälp).

Uppe till höger finns det några ikoner som du kan klicka
på för att nå de vanligaste funktionerna:
...
Klickar du på sidtiteln som finns i högst upp i sidhuvudet, så visas alla sidor som den här sidan refereras från. 
Längs ner på sidan hittar du de traditionella redigerings- och söklänkarna från original-wikin. Dessutom finns det fält för snabbsökning bland titlar och sidtext och länkar för anpassningsbara kommandon som är installerade.
