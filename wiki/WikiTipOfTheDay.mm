 ...
 * You may want to call <<Action(bookmark, Set bookmark)>> on RecentChanges and come back later to read new changes. (For using that feature you have to be logged in!)
