...
## Translator note: you don't need to translate this page.
...
If you do not have superuser rights, follow these instructions:
 ...
 1. Reload this page.
 1. '''install''' links should appear for each package.
 1. Click on the link for each of the packages you wish to install.
