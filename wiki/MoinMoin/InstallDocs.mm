 ...
 * [#basic-install Basic Installation] explains the "`setup.py`" step of the installation in more detail. This is uses to get the Moin``Moin code and wiki template installed onto your system. This applies equally to all scenarios, and you should read it before trying a live installation.
...
<<Include(HelpOnInstalling/ApacheWithFastCgi, "FastCGI Setup using Apache", 1)>>
------
