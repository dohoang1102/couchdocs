 ...
 * wiki:Self:HilfeZurSeitenErzeugung#variablenersetzung - welche Variablen es gibt (wie @''''''SIG@, @''''''MAILTO@ ...)
 * HilfeZuMakros - System-Makros
 * HilfeZuProzessoren - datenverarbeitende Skripte
...
Um mit der Wiki-Notation zu experimentieren, gehen Sie in die WikiSandBox und klicken Sie dann auf "<<GetText(EditText)>>" im Fußbereich der Seite. Benutzen Sie die Funktion "Öffne diesen Link in neuem Fenster" Ihres Browsers auf dem Wort "WikiSandBox", dann können Sie die Hilfeseiten und die WikiSandBox Seite an Seite gleichzeitig geöffnet haben.
