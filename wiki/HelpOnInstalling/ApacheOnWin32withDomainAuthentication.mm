...
Edit your {{{http.conf}}} file (usually found in {{{c:\Program Files\Apache Group\Apache2\conf\}}}). Use an appropriate text editor (such as <<http://notepad-plus.sourceforge.net|Notepad++>>), avoid using !NotePad.
